...
Test(And4081, testAnd)
{
    nts::Circuit circuit("Test", 0);
    nts::IComponent &comp = circuit.createComponent("4081", "and");
    ...
    cr_assert_eq(comp.readStateAt(3), nts::FALSE);
    cr_assert_eq(comp.readStateAt(9), nts::UNDEFINED);
    cr_assert_eq(comp.readStateAt(10), nts::FALSE);
}